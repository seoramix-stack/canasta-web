...
class CanastaBot {
    constructor(seat, difficulty, type = '4p', injectedDna = null) {
        ...
        const DNA_4P = { 
            DISCARD_WILD_PENALTY: 505,
  DISCARD_RED3_PENALTY: 1703.6339326064992,
  FEED_ENEMY_MELD: 3878.1440945063423,
  DISCARD_SINGLE_BONUS: -109,
  MELD_AGGRESSION: 0.7907962091656807,
  PICKUP_THRESHOLD: 2,
  MELD_IF_WINNING_BONUS: -0.16394522327158145,
  MELD_IF_LOSING_BONUS: 0.1683905172613362
        };
