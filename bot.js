...
class CanastaBot {
    constructor(seat, difficulty, type = '4p', injectedDna = null) {
        ...
        const DNA_2P = {
            ...
            FEED_ENEMY_MELD: 2071.4318065399307,
            DISCARD_SINGLE_BONUS: -93,
            MELD_AGGRESSION: 0.9157130361126536,
            PICKUP_THRESHOLD: 2,
            MELD_IF_WINNING_BONUS: 0.04968147629249092,
            MELD_IF_LOSING_BONUS: -0.18977387505924434
        };

        const DNA_4P = { 
            DISCARD_WILD_PENALTY: 1732,
    FEED_ENEMY_MELD: 3012.502351699649,
    DISCARD_SINGLE_BONUS: -93,
    MELD_AGGRESSION: 0.8443982846095403,
    PICKUP_THRESHOLD: 2,
    MELD_IF_WINNING_BONUS: 0.04968147629249092,
    MELD_IF_LOSING_BONUS: -0.18977387505924434,
    DISCARD_RED3_PENALTY: 1074.5474231352075
        };
